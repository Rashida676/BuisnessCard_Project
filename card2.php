        ...
        <div class="col-md-6">
          ...
          <div class="card bg-dark text-white">
            ...
            <div class="card-img-overlay">
                <div class="row">
                    <div class="col-md-6">
                        <h5 style="color:black;padding:10px;" class="card-title"><?php echo $name;?></h5>
                       <p  style="color:black;padding:10px;" class="card-text"><?php echo $description;?></p>
                       <p   style="color:black;padding:10px;" class="card-text"><?php echo $email;?></p>
                    </div>
                      <div class="col-md-6">
